		...
		register_graphql_object_type(
			...
			[
				...
				'fields'      => [
					...
					'sidebarThree'    => [
						'type'        => 'String',
						'description' => __( 'sidebarThree', 'headless-cms' ),
					],
					'sidebarFour'    => [
						'type'        => 'String',
						'description' => __( 'sidebarFour', 'headless-cms' ),
					],
				],
			]
		);
			...
			[
				...
				'resolve'     => function () {
					...
					return [
						...
						'sidebarThree'    => $this->get_sidebar( 'hcms-footer-sidebar-3' ),
						'sidebarFour'    => $this->get_sidebar( 'hcms-footer-sidebar-4' ),
					];
